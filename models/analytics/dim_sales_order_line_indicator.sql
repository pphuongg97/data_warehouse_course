...
SELECT
 CONCAT(dim_sales_order_line_indicator.is_under_supply_backed_order_boolean, "," , stg_dim_package_type.package_type_key) AS sales_order_line_indicator_key
...
CROSS JOIN `learn-dbt-379601.wide_world_importers_dwh_staging.stg_dim_package_type` AS stg_dim_package_type
